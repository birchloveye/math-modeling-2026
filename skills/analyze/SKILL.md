...
使用 `tools/schema_check.py schemas/problem.schema.json workspace/problem/problem_contract.json` 校验 JSON Schema。只汇总会实质影响后续工作的歧义，然后在 `gates/human_gate.md` 停止。未经明确批准，不得进入 P2 或 P3。
